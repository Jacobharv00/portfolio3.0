...
export const TimeLineData = [
    {
        year: 2020,
        text: "Started learning how to program by taking a Udemy JavaScript Course everyday after work.",
    },
    {
        year: 2021,
        text: "Built my first todo application and hangman game, and deployed them both live for anyone in the world to use.",
    },
    {
        year: 2021,
        text: "Accepted into Flatiron School for Full Stack Software Engineering program.",
    },
    {
        year: 2021,
        text: "Flatiron School: Learned a variety of programming languages and techniques for building full stack applications, and built projects with a new partner every three weeks.",
    },
    {
        year: 2021,
        text: "Graduated Flatiron School with 5 completed projects, two of which are Full Stack applications, and an even greater love for coding and solving problems.",
    },
    {
        year: 2021,
